...
function preload() {
  spaceshipImg = loadImage('brick-breaker-master/images/spaceship.png');
  backgroundImg = loadImage('brick-breaker-master/images/background.jpg');
  skateboardImg = loadImage('brick-breaker-master/images/skateboard.png');
  ballImg = loadImage('brick-breaker-master/images/ball.png');
  ballSound = loadSound('brick-breaker-master/sounds/ball.wav');
  brickSound = loadSound('brick-breaker-master/sounds/brick.wav');
  failSound = loadSound('brick-breaker-master/sounds/fail.wav');
}
